...
class TriScape_CMV12000(triscape.TriScape):
    """
    TriScape_CMV12000 class

    Inherits from the TriScape class and extends it for CMV12000 specific commands and requests.
    """

    def __init__(self, EGSE = None, I2Caddr = None):
        """
        TriScape_CMV12000 Constructor
        ...
        """
        print("####### This class has been replaced. Please use TriScape100 or MonoScape100 class")
        return
