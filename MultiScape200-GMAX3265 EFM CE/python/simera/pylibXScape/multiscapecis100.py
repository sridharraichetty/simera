'''
Simera Sense MultiScapeCIS100 Class
...
class MultiScapeCIS100(snapshot.SnapShot, linescan.LineScan, cmv12000.CMV12000):
    """
    MultiScapeCIS100 class

    Inherits from the SnapShot, LineScan and CMV12000 class and extends it for MultiScape100 specific parameters, commands and requests.
    """

    def __init__(self, EGSE = None, I2Caddr = None):
        """
        MultiScapeCIS100 Constructor
        ...
        self.total_current_info = {'Name':'Current', 'Unit':'mA',  'Range_FeeOff':{'Min': 500, 'Max':  900}, 'Range_FeeOn':{'Min': 1000, 'Max':  1600}}
