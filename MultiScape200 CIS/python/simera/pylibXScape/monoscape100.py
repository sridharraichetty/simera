...
class MonoScape100(snapshot.SnapShot, cmv12000.CMV12000):
    """
    MonoScape100 class

    Inherits from the SnapShot class and CMV12000 class, and extends it for MonoScape100 specific commands and requests.
    """

    def __init__(self, EGSE = None, I2Caddr = None):
        """
        MonoScape100 Constructor
